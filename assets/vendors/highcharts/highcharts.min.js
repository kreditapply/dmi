...
*/
(function(U, K) {
    "object" === typeof module && module.exports ? (K["default"] = K, module.exports = U.document ? K(U) : K) : "function" === typeof define && define.amd ? define("highcharts/highcharts", function() {
        return K(U)
    ...
    var f = {};
    K(f, "Core/Globals.html", [], function() {
        var a;
        (function(a) {
            ...
            a.hasBidiBug = a.isFirefox && 4 > parseInt(a.userAgent.split("Firefox/index.html")[1], 10);
    ...
    K(f, "Core/Utilities.html", [f["Core/Globals.js"]], function(a) {
        function f(d, r, h, l) {
    ...
    K(f, "Core/Chart/ChartDefaults.html", [], function() {
        return {
            alignThresholds: !1,
            panning: {
                enabled: !1,
    ...
    K(f, "Core/Color/Color.html", [f["Core/Globals.js"], f["Core/Utilities.js"]], function(a, f) {
        var C = f.isNumber,
            H = f.merge,
            w = f.pInt;
        f = function() {
    ...
    K(f, "Core/Color/Palettes.html", [], function() {
        return {
            colors: "#7cb5ec #434348 #90ed7d #f7a35c #8085e9 #f15c80 #e4d354 #2b908f #f45b5b #91e8e1".split(" ")
        }
    });
    K(f, "Core/Time.html", [f["Core/Globals.js"], f["Core/Utilities.js"]], function(a, f) {
        var C = a.win,
            H = f.defined,
            w = f.error,
            E = f.extend,
    ...
    K(f, "Core/DefaultOptions.html", [f["Core/Chart/ChartDefaults.js"], f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Color/Palettes.js"], f["Core/Time.js"], f["Core/Utilities.js"]], function(a, f, B, H, w, E) {
        f = f.parse;
        var C = E.merge,
            A = {
                colors: H.colors,
    ...
    K(f, "Core/Animation/Fx.html", [f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Utilities.js"]], function(a, f, B) {
        var C = a.parse,
            w = f.win,
            E = B.isNumber,
            I = B.objectEach;
    ...
    K(f, "Core/Animation/AnimationUtilities.html", [f["Core/Animation/Fx.js"],
        f["Core/Utilities.js"]
    ], function(a, f) {
        function C(c) {
            return u(c) ? n({
    ...
    K(f, "Core/Renderer/HTML/AST.html", [f["Core/Globals.js"], f["Core/Utilities.js"]], function(a, f) {
        var C = a.SVG_NS,
            H = f.attr,
            w = f.createElement,
            E = f.css,
        ...
        A = function() {
            ...
            g.filterUserAttributes = function(c) {
                n(c, function(e, p) {
                    var q = !0; - 1 === g.allowedAttributes.indexOf(p) && (q = !1); - 1 !== ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(p) && (q = u(e) && g.allowedReferences.some(function(c) {
    ...
    K(f, "Core/FormatUtilities.html", [f["Core/DefaultOptions.js"], f["Core/Utilities.js"]], function(a, f) {
        function C(a, k, e, c) {
            a = +a || 0;
            k = +k;
            var p = H.lang,
    ...
    K(f, "Core/Renderer/RendererUtilities.html", [f["Core/Utilities.js"]],
        function(a) {
            var f = a.clamp,
                B = a.pick,
                H = a.stableSort,
    ...
    K(f, "Core/Renderer/SVG/SVGElement.html", [f["Core/Animation/AnimationUtilities.js"], f["Core/Renderer/HTML/AST.js"], f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Utilities.js"]], function(a, f, B, H, w) {
        var C = a.animate,
            I = a.animObject,
            A = a.stop,
            u = H.deg2rad,
        ...
        a = function() {
            ...
            a.prototype.align = function(b, c, J) {
                ...
                } else b = this.alignOptions, c = this.alignByTranslate,
                    m = this.alignTo;
    ...
    K(f, "Core/Renderer/RendererRegistry.html", [f["Core/Globals.js"]], function(a) {
        var f;
        (function(f) {
            f.rendererTypes = {};
            var C;
    ...
    K(f, "Core/Renderer/SVG/SVGLabel.html", [f["Core/Renderer/SVG/SVGElement.js"], f["Core/Utilities.js"]], function(a, f) {
    ...
    K(f, "Core/Renderer/SVG/Symbols.html", [f["Core/Utilities.js"]], function(a) {
    ...
    K(f, "Core/Renderer/SVG/TextBuilder.html", [f["Core/Renderer/HTML/AST.js"], f["Core/Globals.js"], f["Core/Utilities.js"]], function(a, f, B) {
        var C = f.doc,
            w = f.SVG_NS,
            E = f.win,
            I = B.attr,
    ...
    K(f, "Core/Renderer/SVG/SVGRenderer.html", [f["Core/Renderer/HTML/AST.js"], f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Renderer/RendererRegistry.js"], f["Core/Renderer/SVG/SVGElement.js"], f["Core/Renderer/SVG/SVGLabel.js"], f["Core/Renderer/SVG/Symbols.js"], f["Core/Renderer/SVG/TextBuilder.js"], f["Core/Utilities.js"]], function(a, f, B, H, w, E, I, A, u) {
        var n = B.charts,
            k = B.deg2rad,
            e = B.doc,
            c = B.isFirefox,
    ...
    K(f, "Core/Renderer/HTML/HTMLElement.html", [f["Core/Globals.js"], f["Core/Renderer/SVG/SVGElement.js"], f["Core/Utilities.js"]], function(a, f, B) {
        var C = this && this.__extends || function() {
                var c = function(a, e) {
    ...
    K(f, "Core/Renderer/HTML/HTMLRenderer.html", [f["Core/Renderer/HTML/AST.js"], f["Core/Renderer/SVG/SVGElement.js"], f["Core/Renderer/SVG/SVGRenderer.js"], f["Core/Utilities.js"]], function(a, f, B, H) {
        var C = this && this.__extends || function() {
                var a = function(k, e) {
                    a = Object.setPrototypeOf || {
                        __proto__: []
    ...
    K(f, "Core/Axis/AxisDefaults.html", [], function() {
        var a;
        (function(a) {
    ...
    K(f, "Core/Foundation.html", [f["Core/Utilities.js"]], function(a) {
        var f = a.addEvent,
            B = a.isFunction,
            H = a.objectEach,
            w = a.removeEvent,
    ...
    K(f, "Core/Axis/Tick.html", [f["Core/FormatUtilities.js"], f["Core/Globals.js"], f["Core/Utilities.js"]], function(a, f, B) {
        var C = f.deg2rad,
            w = B.clamp,
            E = B.correctFloat,
            I = B.defined,
        ...
        f = function() {
            ...
            g.prototype.moveLabel = function(a, e) {
                var g = this,
                    ...
                    m = !1;
                k && k.textStr === a ?
                    (g.movedLabel = k, m = !0, delete g.label) : c(f.ticks, function(b) {
    ...
    K(f, "Core/Axis/Axis.html", [f["Core/Animation/AnimationUtilities.js"], f["Core/Axis/AxisDefaults.js"], f["Core/Color/Color.js"], f["Core/DefaultOptions.js"], f["Core/Foundation.js"], f["Core/Globals.js"],
        ...
        a = function() {
            ...
            a.prototype.addTitle = function(b) {
                ...
                this.axisTitle || ((g = h.textAlign) || (g = (a ? {
                        ...
                        rotation: h.rotation,
                        align: g
                    }).addClass("highcharts-axis-title"), l || this.axisTitle.css(d(h.style)), this.axisTitle.add(this.axisGroup),
    ...
    K(f, "Core/Axis/DateTimeAxis.html", [f["Core/Utilities.js"]], function(a) {
        var f = a.addEvent,
            B = a.getMagnitude,
    ...
    K(f, "Core/Axis/LogarithmicAxis.html", [f["Core/Utilities.js"]], function(a) {
        var f = a.addEvent,
    ...
    K(f, "Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.html", [f["Core/Utilities.js"]], function(a) {
        var f = a.erase,
            B = a.extend,
            H = a.isNumber,
            w;
        (function(a) {
            ...
            a.compose =
                function(a, k) {
                    A || (A = a); - 1 === w.indexOf(k) && (w.push(k), B(k.prototype, u.prototype));
                    return k
                };
            var u = function() {
                function a() {}
    ...
    K(f, "Core/Axis/PlotLineOrBand/PlotLineOrBand.html", [f["Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js"], f["Core/Utilities.js"]], function(a, f) {
        var C = f.arrayMax,
            H = f.arrayMin,
            w = f.defined,
    ...
    K(f, "Core/Tooltip.html", [f["Core/FormatUtilities.js"], f["Core/Globals.js"], f["Core/Renderer/RendererUtilities.js"], f["Core/Renderer/RendererRegistry.js"], f["Core/Utilities.js"]],
        function(a, f, B, H, w) {
            var C = a.format,
                I = f.doc,
                A = B.distribute,
                    ...
                    b = b.slice(0, a.length + 1).reduce(function(b, e, h) {
                        if (!1 !== e && "" !== e) {
                            ...
                            r || (r = {
                                padding: G.padding,
                                r: G.borderRadius
                            }, w || (r.fill = G.backgroundColor, r["stroke-width"] = G.borderWidth), r = W.label("", 0, 0, G[v ? "headerShape" : "shape"], void 0, void 0, G.useHTML).addClass((v ? "highcharts-tooltip-header " :
                            ...
                            "number" ===
                            typeof q ? (v = v.height + 1, p = T ? T.call(c, e, v, h) : d(D, q, l, e), b.push({
                                align: T ? 0 : void 0,
                                anchorX: D,
                                anchorY: q,
                                boxWidth: e,
    ...
    K(f, "Core/Series/Point.html", [f["Core/Renderer/HTML/AST.js"], f["Core/Animation/AnimationUtilities.js"], f["Core/DefaultOptions.js"], f["Core/FormatUtilities.js"], f["Core/Utilities.js"]], function(a, f, B, H, w) {
        var C = f.animObject,
            I = B.defaultOptions,
            A = H.format,
            u = w.addEvent,
    ...
    K(f, "Core/Pointer.html", [f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Tooltip.js"], f["Core/Utilities.js"]], function(a, f, B, H) {
        var w = a.parse,
            C = f.charts,
            I = f.noop,
            A = H.addEvent,
    ...
    K(f, "Core/MSPointer.html", [f["Core/Globals.js"], f["Core/Pointer.js"], f["Core/Utilities.js"]], function(a, f, B) {
        function C() {
            var a = [];
            a.item = function(a) {
                return this[a]
    ...
    K(f, "Core/Legend/Legend.html", [f["Core/Animation/AnimationUtilities.js"], f["Core/FormatUtilities.js"],
        ...
        E = function() {
            ...
            a.prototype.render = function() {
                ...
                p += e;
                l || (this.box = l =
                    a.rect().addClass("highcharts-legend-box").attr({
                        r: c.borderRadius
                    }).add(f));
                b.styledMode || l.attr({
            ...
            a.prototype.handleOverflow = function(b) {
                ...
                b && 0 < h && b > h && !1 !== k.enabled ? (this.clipHeight = G = Math.max(h - 20 - this.titleHeight - f, 0), this.currentPage = z(this.currentPage, 1), this.fullHeight = b, q.forEach(function(b, a) {
                    ...
                    a.scroll(-1, m)
                }), this.pager = d.text("", 15, 10).addClass("highcharts-legend-navigation"), !c.styledMode && k.style && this.pager.css(k.style), this.pager.add(M), this.down = d.symbol("triangle-down", 0, 0, p, p).add(M), y("downTracker").on("click",
                    function() {
                        a.scroll(1, m)
    ...
    K(f, "Core/Series/SeriesRegistry.html", [f["Core/Globals.js"], f["Core/DefaultOptions.js"], f["Core/Series/Point.js"], f["Core/Utilities.js"]], function(a, f, B, H) {
    ...
    K(f, "Core/Chart/Chart.html", [f["Core/Animation/AnimationUtilities.js"], f["Core/Axis/Axis.js"], f["Core/FormatUtilities.js"], f["Core/Foundation.js"], f["Core/Globals.js"], f["Core/Legend/Legend.js"], f["Core/MSPointer.js"], f["Core/DefaultOptions.js"], f["Core/Pointer.js"], f["Core/Renderer/RendererRegistry.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Renderer/SVG/SVGRenderer.js"], f["Core/Time.js"], f["Core/Utilities.js"], f["Core/Renderer/HTML/AST.js"]],
    ...
    K(f, "Core/Legend/LegendSymbol.html", [f["Core/Utilities.js"]], function(a) {
        var f = a.merge,
            B = a.pick,
            H;
        (function(a) {
    ...
    K(f, "Core/Series/SeriesDefaults.html", [], function() {
        return {
            lineWidth: 2,
            allowPointSelect: !1,
            crisp: !0,
    ...
    K(f, "Core/Series/Series.html", [f["Core/Animation/AnimationUtilities.js"], f["Core/DefaultOptions.js"], f["Core/Foundation.js"], f["Core/Globals.js"], f["Core/Legend/LegendSymbol.js"], f["Core/Series/Point.js"], f["Core/Series/SeriesDefaults.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Renderer/SVG/SVGElement.js"], f["Core/Utilities.js"]], function(a, f, B, H, w, E, I, A, u, n) {
        ...
        a = function() {
            ...
            a.prototype.updateData = function(b, a) {
                ...
                else !f || d && d.enabled ? n = !1 : (b.forEach(function(b, a) {
            ...
            a.prototype.setData = function(b, a, c, d) {
                ...
                if (!t) {
                    ...
                    if (p && v > p)
                        ...
                        for (c = 0; c < v; c++) "undefined" !== typeof b[c] && (d = {
                            series: e
            ...
            a.prototype.update = function(b, a) {
                ...
                r && (n.push("data", "isDirtyData", "points", "processedData", "processedXData", "processedYData", "xIncrement", "cropped", "_hasPointMarkers", "_hasPointLabels", "clips", "nodes", "layout", "level", "mapMap", "mapData",
                    "minY", "maxY", "minX", "maxX"), !1 !== b.visible && n.push("area", "graph"), c.parallelArrays.forEach(function(b) {
                    n.push(b + "Data")
    ...
    K(f, "Extensions/ScrollablePlotArea.html", [f["Core/Animation/AnimationUtilities.js"], f["Core/Axis/Axis.js"], f["Core/Chart/Chart.js"], f["Core/Series/Series.js"], f["Core/Renderer/RendererRegistry.js"], f["Core/Utilities.js"]], function(a, f, B, H, w, E) {
        var C = a.stop,
            A = E.addEvent,
            u = E.createElement,
            n = E.merge,
    ...
    K(f, "Core/Axis/StackingAxis.html", [f["Core/Animation/AnimationUtilities.js"], f["Core/Axis/Axis.js"], f["Core/Utilities.js"]], function(a, f, B) {
    ...
    K(f, "Extensions/Stacking.html", [f["Core/Axis/Axis.js"], f["Core/Chart/Chart.js"],
            ...
            t = function() {
                ...
                a.prototype.setOffset = function(a, e, f, k, m) {
                    ...
                    e && h && (m = e.getBBox(), k = e.padding, l = "left" === l ? b.inverted ? -k : k : "right" === l ? m.width : b.inverted && "center" === l ? m.width / 2 : b.inverted ? f ? m.width + k : -k : m.width / 2, f = b.inverted ? m.height / 2 : f ? -k : m.height, this.alignOptions.x = g(this.options.x, 0), this.alignOptions.y = g(this.options.y, 0), h.x -= l, h.y -= f, e.align(this.alignOptions, null, h), b.isInsidePlot(e.alignAttr.x + l - this.alignOptions.x,
                        e.alignAttr.y + f - this.alignOptions.y) ? e.show() : (e.hide(), a = !1), a && w.prototype.justifyDataLabel.call(this.axis, e, this.alignOptions, e.alignAttr, m, h), e.attr({
                        x: e.alignAttr.x,
                        y: e.alignAttr.y
    ...
    K(f, "Series/Line/LineSeries.html", [f["Core/Series/Series.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]],
        function(a, f, B) {
            var C = this && this.__extends || function() {
                    var a = function(f, u) {
                        a = Object.setPrototypeOf || {
    ...
    K(f, "Series/Area/AreaSeries.html", [f["Core/Color/Color.js"], f["Core/Legend/LegendSymbol.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]], function(a, f, B, H) {
    ...
    K(f, "Series/Spline/SplineSeries.html", [f["Core/Series/SeriesRegistry.js"],
        f["Core/Utilities.js"]
    ], function(a, f) {
        var C = this && this.__extends || function() {
                var a = function(f, u) {
    ...
    K(f, "Series/AreaSpline/AreaSplineSeries.html", [f["Series/Area/AreaSeries.js"], f["Series/Spline/SplineSeries.js"], f["Core/Legend/LegendSymbol.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]],
        function(a, f, B, H, w) {
            var C = this && this.__extends || function() {
                    var a = function(f, e) {
                        a = Object.setPrototypeOf || {
    ...
    K(f, "Series/Column/ColumnSeries.html", [f["Core/Animation/AnimationUtilities.js"], f["Core/Color/Color.js"], f["Core/Globals.js"], f["Core/Legend/LegendSymbol.js"], f["Core/Series/Series.js"], f["Core/Series/SeriesRegistry.js"],
        f["Core/Utilities.js"]
    ], function(a, f, B, H, w, E, I) {
        var C = this && this.__extends || function() {
                var a = function(c, b) {
    ...
    K(f, "Core/Series/DataLabel.html", [f["Core/Animation/AnimationUtilities.js"], f["Core/FormatUtilities.js"], f["Core/Utilities.js"]], function(a, f, B) {
        var C = a.getDeferredAnimation,
            w = f.format,
            E = B.defined,
            I = B.extend,
    ...
    K(f, "Series/Column/ColumnDataLabel.html", [f["Core/Series/DataLabel.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]], function(a, f, B) {
        var C = f.series,
            w = B.merge,
            E = B.pick,
            I;
        (function(f) {
            ...
            f.compose = function(f) {
                a.compose(C); - 1 === n.indexOf(f) && (n.push(f), f.prototype.alignDataLabel = u)
            }
        })(I || (I = {}));
        return I
    });
    K(f, "Series/Bar/BarSeries.html", [f["Series/Column/ColumnSeries.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]], function(a, f, B) {
        var C = this && this.__extends || function() {
                var a = function(f, u) {
                    a = Object.setPrototypeOf || {
                        __proto__: []
    ...
    K(f, "Series/Scatter/ScatterSeries.html", [f["Series/Column/ColumnSeries.js"],
    ...
    K(f, "Series/CenteredUtilities.html", [f["Core/Globals.js"], f["Core/Series/Series.js"], f["Core/Utilities.js"]], function(a, f, B) {
        var C = a.deg2rad,
            w = B.isNumber,
            E = B.pick,
            I = B.relativeLength,
    ...
    K(f, "Series/Pie/PiePoint.html", [f["Core/Animation/AnimationUtilities.js"], f["Core/Series/Point.js"], f["Core/Utilities.js"]], function(a, f, B) {
        var C = this && this.__extends || function() {
                var a = function(e, c) {
                    a = Object.setPrototypeOf || {
                        __proto__: []
        ...
        f = function(a) {
            ...
            e.prototype.setVisible = function(a, e) {
                ...
                }), this.legendItem && k.legend.colorizeItem(this,
    ...
    K(f, "Series/Pie/PieSeries.html", [f["Series/CenteredUtilities.js"], f["Series/Column/ColumnSeries.js"], f["Core/Globals.js"], f["Core/Legend/LegendSymbol.js"], f["Series/Pie/PiePoint.js"], f["Core/Series/Series.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Renderer/SVG/Symbols.js"], f["Core/Utilities.js"]], function(a, f, B, H, w, E, I, A, u) {
    ...
    K(f, "Series/Pie/PieDataLabel.html", [f["Core/Series/DataLabel.js"],
    ...
    K(f, "Extensions/OverlappingDataLabels.html", [f["Core/Chart/Chart.js"], f["Core/Utilities.js"]], function(a, f) {
        function C(a, f) {
            var e = !1;
            if (a) {
                var c = a.newOpacity;
    ...
    K(f, "Core/Responsive.html", [f["Core/Utilities.js"]], function(a) {
        var f = a.extend,
            B = a.find,
            H = a.isArray,
            w = a.isObject,
        ...
        (function(a) {
            ...
            var e = function() {
                ...
                a.prototype.setResponsive = function(a, c) {
                    ...
                    k = k.toString() || void 0;
                    k !== (g && g.ruleIds) && (g &&
                        this.update(g.undoOptions, a, !0), k ? (g = this.currentOptions(c), g.isResponsiveOptions = !0, this.currentResponsive = {
                            ruleIds: k,
                            mergedOptions: c,
                            undoOptions: g
    ...
    K(f, "masters/highcharts.src.html", [f["Core/Globals.js"], f["Core/Utilities.js"], f["Core/DefaultOptions.js"], f["Core/Animation/Fx.js"], f["Core/Animation/AnimationUtilities.js"], f["Core/Renderer/HTML/AST.js"], f["Core/FormatUtilities.js"], f["Core/Renderer/RendererUtilities.js"],
